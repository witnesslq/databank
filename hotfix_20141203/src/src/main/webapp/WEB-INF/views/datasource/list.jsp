    ...
    <div class="">
      <q:querytable queryKey="queryDataSource" class="list" formId="form">
        ...
        <q:column title="" escape="false" id="forSelectAll" width="30px">
          <input type="checkbox" name="dsIds" value="<e:property value="@ds_id"/>"/>
        </q:column>
...
<script>
  $(function () {
    $("#forSelectAll").html("<input type='checkbox' id='selectAll' name='dsId'/>");
    $("#selectAll").click(function () {
      $('input[type="checkbox"][name="dsIds"]').attr("checked", this.checked);
    });
  });
  function update(id) {
