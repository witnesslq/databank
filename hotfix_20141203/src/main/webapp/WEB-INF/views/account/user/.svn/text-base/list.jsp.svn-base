    ...
    <div class="Content fontText">
                ...
                <div class="search_con">
                    <ul class="fix">
                        ...
                        <li>
                            ...
                            <e:select class="select" name="roleId" headerKey="" headerValue="全部" listKey="id"
                                      listValue="name"
                                      list="@roleList"/>
                        </li>
                    </ul>
        ...
        <div class="">
            <q:querytable queryKey="queryUser" class="list" formId="form">
                ...
                <q:column title="可用操作" width="200px">
                    <a href="javascript:void(0)" onclick="update(<e:property value="@user_id"/>, 'edit');">编辑</a>
                    <a href="javascript:void(0)" onclick="viewApplDetail(<e:property value="@user_id"/>, 'edit');">查看申请权限</a>
...
<script>
    ...
    function viewApplDetail(id) {
        window.location.href = "<%=request.getContextPath()%>/application/loadApplDs.action?id=" + id;
    }
</script>
</body>
</html>