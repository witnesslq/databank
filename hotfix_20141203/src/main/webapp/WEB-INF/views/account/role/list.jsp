                ...
                <div class="search_con">
                    <ul class="fix">
                        ...
                        <li>
                            ...
                            <e:select class="select" name="dsId" headerKey="" headerValue="全部" listKey="id"
                                      listValue="name"
                                      list="@dsList"/>
                        </li>
                    </ul>
            ...
            <q:querytable queryKey="queryRole" class="list" formId="form">
                ...
                <q:column title="可用操作" width="100px">
                    ...
                    <a href="javascript:void(0)"
                       onclick="deleteRole(<e:property value="@role_id"/>, '角色', 'role');">删除</a>
                </q:column>
            </q:querytable>
        </div>
    </div>
...
<script>
    ...
    function deleteRole(id, objStr, selecter) {
