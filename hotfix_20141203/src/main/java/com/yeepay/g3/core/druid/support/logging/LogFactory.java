...
public class LogFactory {
	...
	static {
		...
		tryImplementation("org.apache.log4j.Logger", "com.yeepay.g3.core.druid.support.logging.Log4jImpl");
		tryImplementation("java.util.logging.Logger", "com.yeepay.g3.core.druid.support.logging.Jdk14LoggingImpl");
		tryImplementation("org.slf4j.Logger", "com.yeepay.g3.core.druid.support.logging.SLF4JImpl");
		tryImplementation("org.apache.commons.logging.LogFactory",
				"com.yeepay.g3.core.druid.support.logging.JakartaCommonsLoggingImpl");
	...
	public static synchronized void selectLog4JLogging() {
		try {
			...
			Class implClass = Resources.classForName("com.yeepay.g3.core.druid.support.logging.Log4jImpl");
			logConstructor = implClass.getConstructor(new Class[]{String.class});
		} catch (Throwable t) {
		}
	}
	...
	public static synchronized void selectJavaLogging() {
		try {
			...
			Class implClass = Resources.classForName("com.yeepay.g3.core.druid.support.logging.Jdk14LoggingImpl");
			logConstructor = implClass.getConstructor(new Class[]{String.class});
		} catch (Throwable t) {
		}
	}
