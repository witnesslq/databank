...
import com.yeepay.g3.core.druid.sql.ast.statement.SQLExprTableSource;
import com.yeepay.g3.core.druid.sql.ast.statement.SQLSelectItem;
import com.yeepay.g3.core.druid.sql.ast.statement.SQLSelectQueryBlock;
import com.yeepay.g3.core.druid.sql.visitor.functions.*;
import com.yeepay.g3.core.druid.wall.spi.WallVisitorUtils;
import com.yeepay.g3.core.druid.wall.spi.WallVisitorUtils.WallConditionContext;
import com.yeepay.g3.core.druid.wall.spi.WallVisitorUtils.WallSelectQueryContext;
...
public class SQLEvalVisitorUtils {
	...
	public static Date castToDate(String text) {
		...
		try {
			...
			throw new RuntimeException("format : " + format + ", value : " + text, e);
		}
	}
