...
import com.yeepay.g3.app.databank.QuickStartServer;
import com.yeepay.g3.core.data.DataFixtures;
import com.yeepay.g3.core.jetty.JettyFactory;
import com.yeepay.g3.core.spring.Profiles;
import com.yeepay.g3.core.utils.PropertiesLoader;
...
public class BaseFunctionalTestCase {
	...
	protected static void reloadSampleData() throws Exception {
		...
		DataFixtures.executeScript(dataSource, "classpath:" + dbType + "/dbschema.sql", "classpath:"
				+ dbType + "/dbinit.sql");
	}
}